...
public class OcrServiceImpl implements OcrService {
    ...
    /**
     * 身份证识别功能接口。
     * 通过调用腾讯云OCR服务，识别上传的身份证图片中的信息，并将识别结果封装成IdCardOcrVo对象返回。
     * 支持识别身份证的正反面，根据识别的内容不同，分别处理并保存相应的信息。
     * 文档地址:
     ...
     * @return 包含身份证识别信息的IdCardOcrVo对象
     * @throws Exception 如果识别过程中发生错误，抛出异常
     */
    @SneakyThrows
    @Override
